...
# - Loops through each year and downloads .tar.gz files containing satellite images for Indian Ocean cyclones
# - Only extracts files from the .tar.gz files that contain images of cyclones that we know the wind speed of
...
def download_hursat(years):
    ...
    for year in years:
        ...
        for storm_file_url in year_directory_file_urls:
            ...
            # out storms in basins other than the Indian Ocean, since the best track dataset doesn't have
