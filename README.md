...
There is growing interest in applying AI and machine learning techniques to improve the accuracy of operational meteorological tasks, including estimating hurricane wind speed.

I started working on this project when I decided to take part in the Smart India Hackathon 2022 and selected the problem statement provided by the Department of Space and Indian Space and Reserch Organization.
